module.exports = {
    ...
    type: "main",
    exec: async(zkyera, m, { commands, args, prefix, text, toUpper }) => {
        if (args[0]) {
            let data = []
            ...
            let templateButtons = [
                {index: 1, urlButton: {displayText: 'Website', url: 'https://hiskia.app'}},
            ]
            ...
            zkyera.sendMessage(m.from, templateMessage, { quoted: m })
        }
    }
}
